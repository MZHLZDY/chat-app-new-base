...
import { X, Pencil, AlignLeft } from "lucide-vue-next";
...
const submit = async () => {
    ...
    try {
        await axios.put(`/chat/todos/${props.todo.id}`, {
            title: title.value,
                    ...
                    <div class="custom-modal shadow-lg">
                        <div class="modal-header-custom">
                            <div class="d-flex align-items-center gap-3">
                                <div
                                    class="icon-circle bg-light-warning text-warning"
                                >
                        ...
                        <form @submit.prevent="submit">
                            <div class="modal-body-custom">
                                ...
                                >
                                    <label class="input-label">
                                        <Pencil
                                            class="w-3 h-3 me-2 text-gray-400"
                                        />
                                        Judul Tugas
                                    </label>
                                    <input
                                ...
                                <div class="input-group-custom">
                                    <label class="input-label"><AlignLeft class="w-3 h-3 me-2 text-gray-400" /> Deskripsi</label>
                                    <textarea 
                                        v-model="description" 
                                        rows="3" 
                                        class="form-control-custom" 
                            ...
                            <div class="modal-footer-custom">
                                ...
                                <button
                                    type="submit"
                                    class="btn btn-warning btn-hover-scale shadow-sm text-white"
                                    :disabled="isLoading"
                                >
                                    <span
                                        v-if="isLoading"
...
<style scoped>
/* Gunakan Style yang sama persis dengan TodoForm.vue agar konsisten */
...
.input-group-custom:focus-within {
    ...
    border-color: #f6c000;
    box-shadow: 0 10px 30px rgba(246, 192, 0, 0.1);
